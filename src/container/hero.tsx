...
const Hero = () => {
  return (
    <div className="flex justify-between  pt-[3%] px-[6%] bg-[#F4FFE5]">
      <div className="flex flex-col gap-5 mt-[90px]">
        <h1 className="text-[#0B9444] text-[40px] font-[700]">
        ...
        <Button className="text-[#fff] bg-[#8CC63F] rounded-[50px] py-[15px] px-[30px] text-[16px] font-[600] w-fit">
          Get Started
        </Button>
      </div>
      <Image
