...
const About = () => {
  return (
    <div className="grid grid-cols-2 gap-2 mx-[14%] py-[5%]">
      <Image
      ...
      <div className="flex flex-col gap-10">
        <h2 className="relative text-[30px] text-[#107C41] font-[700] after:content-[''] after:w-[85px] after:bg-[#8CC63F]  after:mt-2 after:rounded-md after:absolute after:h-[5px] after:top-10 after:left-0">
          About Us
        </h2>
