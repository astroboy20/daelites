    ...
    <main className="my-[120px] mx-6 sm:mx-[12%] xl:mx-[12%]">
      <div className="flex flex-col gap-6 sm:gap-8 md:gap-10">
        ...
        <div className="ml-auto">
          <Link href={"/blog"} className=" flex items-center gap-2 text-[#107C41] text-[16px] sm:text-[18px] md:text-[20px] bg-transparent border-2 border-[#8CC63F] rounded-[5px] px-[20px] sm:px-[25px] md:px-[33px] py-[8px] sm:py-[9px] md:py-[10px] hover:bg-[#107C41] hover:text-white">
            <IoMdArrowBack /> Back
          </Link>
        </div>
      </div>
